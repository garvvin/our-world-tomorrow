        ...
        <div className='w-full min-h-80 flex flex-col justify-center place-items-center mt-7'>
          <div className='flex static flex-col gap-7 justify-center place-items-center min-w-[390px] max-w-[650px] w-4/5 max-w-300 relative'>
            ...
            <div className='flex flex-col gap-7 place-items-center relative -top-50'>
              <h2 className='font-extrabold text-xl mt-5 spectral-regular'>Mission Statement</h2>
              <h4 className='text-lg sm:text-xl text-center spectral-regular'>We inspire our youth to take action on social and environmental issues that affect our world for a better tomorrow!</h4>
              <h2 className='font-extrabold text-xl mt-10 spectral-regular'>Who are we?</h2>
              <h4 className='text-lg sm:text-xl text-center spectral-regular'><i>Our World Tomorrow</i> is a non-profit organization aiming to help disadvantaged people through community service and raising awareness on issues that affect today&#39;s world.</h4>
              <h2 className='font-extrabold text-xl mt-10 spectral-regular'>Our Goals</h2>
