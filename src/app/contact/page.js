    ...
    <>
        ...
        <div className='w-full min-h-80 flex flex-col justify-center place-items-center'>
          <div className='flex flex-col gap-7 justify-center place-items-center w-4/5 max-w-300'>
            ...
            <div className='flex flex-col place-items-center px-5 gap-5 min-w-[390px] max-w-[650px] w-full'>
              ...
              <div className='flex w-full justify-end'><button className='duration-300 text-md bg-sky-300 hover:bg-sky-400 active:bg-sky-500 cursor-pointer py-3 px-5 rounded-xl text-white'>Submit</button></div>
            </div>
          </div>
        </div>
    </>
