  ...
  return (
    <>
      ...
      <div className="w-full min-h-80 flex flex-col justify-center place-items-center">
        <div className="flex flex-col mb-10 gap-8 justify-center place-items-center w-4/5 max-w-240 spectral-regular">
          <h2 className="text-xl mt-10 mb-3 spectral-semibold">Our Board</h2>
          <div className="flex gap-7 w-full">
            ...
            <div className="flex flex-col gap-3 pt-15 md:pt-20">
              <h3 className="spectral-bold text-md md:text-lg">
                Founder / Program Coordinator
              </h3>
              <h3 className="text-md md:text-lg spectral-regular">
                Shayla Mol
              </h3>
            </div>
          </div>
          ...
          <div className="flex gap-7 w-full">
            ...
            <div className="flex flex-col gap-3 pt-15 md:pt-20">
              ...
              <h3 className="text-md md:text-lg spectral-regular">Garvin Yu</h3>
            </div>
          </div>
        </div>
      </div>
